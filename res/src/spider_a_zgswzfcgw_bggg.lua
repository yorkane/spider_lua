...
--名称 网站名称_栏目
spiderName="中国税务政府采购网_变更公告";
--代码 区域代码_网站代码_栏目代码
spiderCode="a_zgswzfcgw_bggg";
--是否下载3级页
...
--默认列表页第一页
spiderTargetChannelUrl="http://www.ctaxccgp.com.cn/swcg/bgtz/"
...
function downloadAndParseListPage(pageno)
	...
	if pageno==1 then
		...
		href="http://www.ctaxccgp.com.cn/swcg/bgtz/index_"..tostring(pageno-1)..".htm"
	end	
	...
	for k,v in pairs(list) do
		...
		item["href"]="http://www.ctaxccgp.com.cn/swcg/bgtz"..item["href"]
		tmpstr=""
