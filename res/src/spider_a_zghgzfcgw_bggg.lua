...
--名称 网站名称_栏目
spiderName="中国海关政府采购网_变更公告";
--代码 区域代码_网站代码_栏目代码
spiderCode="a_zghgzfcgw_bggg";
--是否下载3级页
...
spiderLastDownloadTime="2016-02-22 01:10:01";
--执行频率30分钟
spiderRunRate=60;
...
--默认列表页第一页
spiderTargetChannelUrl="http://hgcg.customs.gov.cn/hgcg/cggg/004002/MoreInfo.aspx?CategoryNum=004002"
...
local param={}
local __VIEWSTATE = ""
local __VIEWSTATEGENERATOR = 06435827
...
function downloadAndParseListPage(pageno)
	...
	head={
		...
		["Referer"]="http://hgcg.customs.gov.cn/hgcg/cggg/004002/MoreInfo.aspx?CategoryNum=004002",
	...
	if pageno == 1 then
		...
		content,cks = downloadAdv("http://hgcg.customs.gov.cn/hgcg/cggg/004002/MoreInfo.aspx","get",param,head,cks)
	else
		param={
