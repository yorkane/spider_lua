...
--名称 网站名称_栏目
spiderName="中国海关政府采购网_成交公告";
--代码 区域代码_网站代码_栏目代码
spiderCode="a_zghgzfcgw_cjgg";
--是否下载3级页
...
--默认列表页第一页
spiderTargetChannelUrl="http://hgcg.customs.gov.cn/hgcg/cggg/004004/MoreInfo.aspx?CategoryNum=004004"
...
local param={}
local __VIEWSTATE = ""
local __VIEWSTATEGENERATOR = B1C0ADB7
...
function downloadAndParseListPage(pageno)
	...
	head={
		...
		["Referer"]="http://hgcg.customs.gov.cn/hgcg/cggg/004004/MoreInfo.aspx?CategoryNum=004004",
	...
	if pageno == 1 then
		...
		content,cks = downloadAdv("http://hgcg.customs.gov.cn/hgcg/cggg/004004/MoreInfo.aspx","get",param,head,cks)
	else
		param={
