...
--名称 网站名称_栏目
spiderName="华润煤业_物质招标";
--代码 区域代码_网站代码_栏目代码
spiderCode="a_crcoal_wzzb";
--是否下载3级页
...
--默认列表页第一页
spiderTargetChannelUrl="http://b2bcoal.crp.net.cn/Tender/ShowTenderList.aspx?type=Tender&mode=-1&pre=0"

--取得对方网站最后发布时间 必须返回yyyy-MM-dd HH:mm:ss 格式
function getLastPublishTime()
	return tim=os.date("%Y-%m-%d %H:%M:%S",os.time())
...
function downloadAndParseListPage(pageno)
	local page={}		
	local href="http://b2bcoal.crp.net.cn/Tender/ShowTenderList.aspx?type=Tender&mode=-1&pre=0"
