...
--名称 网站名称_栏目
spiderName="中国建设招标网_中标公示";
--代码 区域代码_网站代码_栏目代码
spiderCode="a_zgjszbw_zbgs";
--是否下载3级页
...
--默认列表页第一页
spiderTargetChannelUrl="http://www.jszhaobiao.com/search.html?scope=1&dt=7&btns=2&page=1"
...
function getLastPublishTime()
	...
	while trylistnum<5 and tmp==nil do
...
function downloadAndParseListPage(pageno)
	...
	if pageno==1 then
		...
		href="http://www.jszhaobiao.com/search.html?scope=1&dt=7&btns=2&page="..tostring(pageno)
	end
