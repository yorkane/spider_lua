...
--名称 网站名称_栏目
spiderName="中国海关政府采购网_招标公告";
--代码 区域代码_网站代码_栏目代码
spiderCode="a_zghgzfcgw_zbgg";
--是否下载3级页
...
--默认列表页第一页
spiderTargetChannelUrl="http://hgcg.customs.gov.cn/hgcg/cggg/004001/MoreInfo.aspx"
...
local param={}
local __VIEWSTATE = ""
local __VIEWSTATEGENERATOR = "48BD9E87"
