...
--名称 网站名称_栏目
spiderName="中国税务政府采购网_中标公告";
--代码 区域代码_网站代码_栏目代码
spiderCode="a_zgswzfcgw_zhbgg";
--是否下载3级页
...
--默认列表页第一页
spiderTargetChannelUrl="http://www.ctaxccgp.com.cn/swcg/zbggaa/"
...
function downloadAndParseListPage(pageno)
	local page={}	
	local loadTwoPage="true"
	local href=spiderTargetChannelUrl
	if pageno==1 then
		href=spiderTargetChannelUrl
	else
		if loadTwoPage=="true" then
			href="http://www.ctaxccgp.com.cn/swcg/zbggaa/index_"..tostring(pageno-1)..".htm"
		else
			return page
		end
	end	
	...
	for k,v in pairs(list) do
		...
		item["href"]="http://www.ctaxccgp.com.cn/swcg/zbggaa"..item["href"]
