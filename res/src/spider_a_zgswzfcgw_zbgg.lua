...
--名称 网站名称_栏目
spiderName="中国税务政府采购网_招标公告";
--代码 区域代码_网站代码_栏目代码
spiderCode="a_zgswzfcgw_zbgg";
--是否下载3级页
...
--默认列表页第一页
spiderTargetChannelUrl="http://www.ctaxccgp.com.cn/swcg/zbgg/index.htm"
...
function downloadAndParseListPage(pageno)
	...
	if pageno==1 then
		...
		href="http://www.ctaxccgp.com.cn/swcg/zbgg/index_"..tostring(pageno-1)..".htm"
	end	

	local content = download(href,{})
	local list = findListHtml("table:eq(4) tbody:eq(0) tr",content)
		-- print("list.size():"..table.getn(list))
		-- os.exit()
	...
	for k,v in pairs(list) do
		...
		item["href"]="http://www.ctaxccgp.com.cn/swcg/zbgg"..item["href"]
		tmpstr=""
