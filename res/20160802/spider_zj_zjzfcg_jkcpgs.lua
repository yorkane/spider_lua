...
--名称 网站名称_栏目
spiderName="浙江政府采购_进口产品公示";
--代码 区域代码_网站代码_栏目代码
spiderCode="zj_zjzfcg_jkcpgs";
--是否下载3级页
...
spiderTargetChannelUrl="http://www.zjzfcg.gov.cn/cggg?pageNum=1&pageCount=30&chnlIds=445AND400AND410&bidType=0&bidWay=0&region=0"
...
function downloadAndParseListPage(pageno)
	...
	if pageno==1 then
		...
		href="http://www.zjzfcg.gov.cn/cggg?pageNum="..tostring(pageno).."&pageCount=30&chnlIds=445AND400AND410&bidType=0&bidWay=0&region=0"
	end
