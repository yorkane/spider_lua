...
--名称 网站名称_栏目
spiderName="广东省招投标监管网_中标结果";
--代码 区域代码_网站代码_栏目代码
spiderCode="gd_gdsztbjgw_zbjg";
--是否下载3级页
...
spiderTargetChannelUrl="http://www.gdzbtb.gov.cn/zhongbiaojieguo/"
...
function downloadAndParseListPage(pageno)
	...
	if pageno==1 then
		...
		href="http://www.gdzbtb.gov.cn/zhongbiaojieguo/index_"..tostring(pageno-1)..".htm"
	end
	...
	for k,v in pairs(list) do
		...
		item["href"]="http://www.gdzbtb.gov.cn/zhongbiaojieguo"..item["href"]
...
function downloadDetailPage(data)
	for i=1,5 do 	--5次下载任务不成功，退出
		...
		data["detail"]=findOneText(".bg8 table:eq(4)",con)
		data["contenthtml"]=findOneHtml(".bg8 table:eq(4)",con)
