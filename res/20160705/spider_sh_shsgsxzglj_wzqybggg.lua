...
--名称 网站名称_栏目
spiderName="上海市工商行政管理局_外资企业变更公告";
--代码 区域代码_网站代码_栏目代码
spiderCode="sh_shsgsxzglj_wzqybggg";
--是否下载3级页
...
spiderTargetChannelUrl="http://www.sgs.gov.cn/shaic/dengjiBulletin!toWzbg.action?regorgan=000000"
...
function downloadAndParseListPage(pageno)
	...
	if pageno==1 then
		...
		href="http://www.sgs.gov.cn/shaic/dengjiBulletin!toWzbg.action".."?regorgan=000000&pageno="..tostring(pageno)
	end
