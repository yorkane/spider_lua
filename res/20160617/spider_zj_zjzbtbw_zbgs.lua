...
--名称 网站名称_栏目
spiderName="浙江招标投标网_中标公示";
--代码 区域代码_网站代码_栏目代码
spiderCode="zj_zjzbtbw_zbgs";
--是否下载3级页
...
--默认列表页第一页
spiderTargetChannelUrl="http://www.zjbid.cn/zjwz/template/default/GGInfo.aspx?CategoryNum=001001009"
...
function downloadAndParseListPage(pageno)
	...
	head={
		...
		["Referer"]="http://www.zjbid.cn/zjwz/template/default/GGInfo.aspx?CategoryNum=001001009",
