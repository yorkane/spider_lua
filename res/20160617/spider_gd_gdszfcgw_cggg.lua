...
--名称 网站名称_栏目
spiderName="广东省政府采购网_采购公告";
--代码 区域代码_网站代码_栏目代码
spiderCode="gd_gdszfcgw_cggg";
--是否下载3级页
...
spiderTargetChannelUrl="http://www.gdgpo.gov.cn/queryMoreInfoList.do?channelCode=0005&sitewebId=-1"

--取得对方网站最后发布时间 必须返回yyyy-MM-dd HH:mm:ss 格式
function getLastPublishTime()
	local content = download(spiderTargetChannelUrl,{})
	local tmp = findOneText(".m_m_c_list li:eq(0) em:eq(0)",content)
...
function downloadAndParseListPage(pageno)
	...
	if pageno==1 then
		...
		href="http://www.gdgpo.gov.cn/queryMoreInfoList.do?channelCode=0005&pageSize15&pointPageIndexId=9&sitewebId=-1&pageIndex="..tostring(pageno)
	end
