...
--名称 网站名称_栏目
spiderName="广东省政府采购网_中标公告";
--代码 区域代码_网站代码_栏目代码
spiderCode="gd_gdszfcgw_zbgg";
--是否下载3级页
...
spiderTargetChannelUrl="http://www.gdgpo.gov.cn/queryMoreInfoList.do?channelCode=0008&sitewebId=-1"
...
function downloadAndParseListPage(pageno)
	...
	if pageno==1 then
		...
		href="http://www.gdgpo.gov.cn/queryMoreInfoList.do?channelCode=0008&sitewebId=-1&pageSize15&pageIndex="..tostring(pageno)
	end
