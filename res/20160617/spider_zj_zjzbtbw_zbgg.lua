...
--名称 网站名称_栏目
spiderName="浙江招标投标网_招标公告";
--代码 区域代码_网站代码_栏目代码
spiderCode="zj_zjzbtbw_zbgg";
--是否下载3级页
...
--默认列表页第一页
spiderTargetChannelUrl="http://www.zjbid.cn/zjwz/template/default/GGInfo.aspx?CategoryNum=001001001"
...
function downloadAndParseListPage(pageno)
	...
	head={
		...
		["Referer"]="http://www.zjbid.cn/zjwz/template/default/GGInfo.aspx?CategoryNum=001001001",
