...
--名称 网站名称_栏目
spiderName="浙江招标投标网_中标候选人公示";
--代码 区域代码_网站代码_栏目代码
spiderCode="zj_zjzbtbw_zbhxrgs";
--是否下载3级页
...
--默认列表页第一页
spiderTargetChannelUrl="http://www.zjbid.cn/zjwz/template/default/GGInfo.aspx?CategoryNum=001001005"
...
function downloadAndParseListPage(pageno)
	...
	head={
		...
		["Referer"]="http://www.zjbid.cn/zjwz/template/default/GGInfo.aspx?CategoryNum=001001005",
...
function downloadDetailPage(data)
	for i=1,5 do 	--5次下载任务不成功，退出
		...
		if data["detail"]==nil or data["detail"]=="" then
			data["detail"]=findOneText(".MsoNormalTable",con)
			data["contenthtml"]=findOneHtml(".MsoNormalTable",con)
		end
		if data["detail"]==nil or data["detail"]=="" then
			data["detail"]=findOneText("#TDContent",con)
			data["contenthtml"]=findOneHtml("#TDContent",con)
		end
